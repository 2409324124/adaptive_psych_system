...
var e = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), t = /* @__PURE__ */ e(((e) => {
	...
	categories: [
		...
		},
		{
			...
			label: "Inference",
			parentId: "runtime",
			pathSegment: "INFERENCE"
		},
		{
			id: "runtime-quantization",
			label: "Quantization",
			parentId: "runtime",
			pathSegment: "QUANTIZATION"
		},
		{
			id: "agent",
			label: "Agent",
	...
	items: [
		{
			...
			action: {
				type: "external",
				target: "https://2409324124.github.io/xeon-max-9470c-benchmarks/report/"
			}
		},
		{
			id: "hbm-stream",
			categoryId: "hardware-memory",
			name: "HBM / STREAM",
			fileName: "HBM_STREAM.TXT",
			type: "Measurement",
			status: "Published",
			icon: "chart",
			action: { type: "notepad" },
			summary: [
				"Intel Xeon Max 9470C · 64 GB HBM2e",
				"",
				"STREAM Copy   658,763.5 MB/s",
				"STREAM Scale  651,040.3 MB/s",
				"STREAM Add    606,724.4 MB/s",
				"STREAM Triad  596,258.8 MB/s",
				"",
				"Measured: 2026-05-30"
			],
			sourceUrl: "https://github.com/2409324124/xeon-max-9470c-benchmarks/blob/main/data/benchmarks.json"
		},
		{
			id: "onednn-amx",
			categoryId: "hardware-cpu",
			name: "oneDNN AMX Kernels",
			fileName: "ONEDNN_AMX.TXT",
			type: "Measurement",
			status: "Published",
			icon: "chip",
			action: { type: "notepad" },
			summary: [
				"Intel Xeon Max 9470C · 52C / 104T",
				"",
				"oneDNN BF16 convolution  44,155 GFLOPS",
				"oneDNN INT8 convolution 105,713 GFLOPS",
				"",
				"Precision note: BF16 / INT8 kernel measurements."
			],
			sourceUrl: "https://github.com/2409324124/xeon-max-9470c-benchmarks/blob/main/data/benchmarks.json"
		},
		{
			id: "qwen3-int4",
			categoryId: "runtime-inference",
			name: "OpenVINO Qwen3-8B INT4",
			fileName: "QWEN3_INT4.TXT",
			type: "Measurement",
			status: "Measured",
			icon: "chip",
			action: { type: "notepad" },
			summary: [
				...
				"NNCF INT4_ASYM · group 128 · CPU",
				"",
				"40 -> 512  C16  203.40 aggregate tok/s",
				"1K -> 128   C8    63.52 aggregate tok/s",
				"4K -> 128   C1    13.54 aggregate tok/s",
				"4K -> 128   C8    16.53 aggregate tok/s",
				"",
				"1,320 measured requests · 0 failures",
				"0 cgroup swap · 0 OOM / oom_kill",
				"WikiText-2 PPL 17.7501 · 296,047 tokens",
				"C4 PPL         15.8424 · 869,183 tokens"
			],
			sourceUrl: "https://github.com/2409324124/xeon-max-9470c-benchmarks/blob/main/evidence/qwen3-8b-int4-baseline.json"
		},
		{
			id: "balanced-int4",
			categoryId: "runtime-quantization",
			name: "Balanced INT4 Fidelity",
			fileName: "BALANCED_INT4.TXT",
			type: "Measurement",
			status: "Measured",
			icon: "document",
			action: { type: "notepad" },
			summary: [
				"Official OpenVINO INT4 / Balanced INT4",
				"",
				"WikiText-2 PPL  17.7501 / 17.8255  (+0.4245%)",
				"C4 PPL          15.8424 / 15.8057  (-0.2319%)",
				"",
				"Compared positions                  50,000",
				"Top-1 agreement                     88.038%",
				"Reference top-1 in candidate top-5  99.47%",
				"Invalid values                      0",
				"",
				"Weight bytes  4,855,348,053 / 6,748,344,786"
			],
			sourceUrl: "https://github.com/2409324124/xeon-max-9470c-benchmarks/blob/main/evidence/balanced-int4-fidelity.json"
		}
	]
}, f = /* @__PURE__ */ e(((e) => {
	...
	t.exports = f();
})))(), m = "C:\\SHINONOME\\BENCHMARKS";
function h(e) {
	let t = /* @__PURE__ */ new Set([e]), n = !0;
	for (; n;) n = !1, d.categories.forEach((e) => {
		e.parentId && t.has(e.parentId) && !t.has(e.id) && (t.add(e.id), n = !0);
	});
	return t;
}
function g(e) {
	let t = [], n = d.categories.find(({ id: t }) => t === e);
	for (; n && n.id !== "root";) t.unshift(n.pathSegment), n = d.categories.find(({ id: e }) => e === n.parentId);
	return t.length ? `${m}\\${t.join("\\")}` : m;
}
function _({ parentId: e, currentId: t, onNavigate: n, depth: r = 0 }) {
	return d.categories.filter((t) => t.parentId === e).map((e) => /* @__PURE__ */ (0, p.jsxs)("div", {
		className: "explorer-tree-branch",
		children: [/* @__PURE__ */ (0, p.jsxs)("button", {
			className: t === e.id ? "is-current" : "",
			style: { paddingLeft: `${8 + r * 14}px` },
			type: "button",
			"aria-label": `浏览 ${e.label}`,
			onClick: () => n(e.id),
			children: [
...
function v({ onOpenItem: e }) {
	let [t, n] = (0, l.useState)("root"), [r, i] = (0, l.useState)([]), [a, o] = (0, l.useState)(null), [s, c] = (0, l.useState)(() => !window.matchMedia?.("(max-width: 760px)").matches), u = (0, l.useMemo)(() => {
		let e = h(t);
		return d.items.filter((t) => e.has(t.categoryId));
	}, [t]);
	function f(e) {
		e !== t && (i((e) => [...e, t]), n(e), o(null));
	}
	function m() {
		let e = r.at(-1);
		e && (i((e) => e.slice(0, -1)), n(e), o(null));
	}
	function v() {
		let e = d.categories.find(({ id: e }) => e === t);
		e?.parentId && f(e.parentId);
	}
	return /* @__PURE__ */ (0, p.jsxs)("div", {
		className: "benchmark-explorer",
		children: [
			...
			/* @__PURE__ */ (0, p.jsxs)("div", {
				...
				children: [
					/* @__PURE__ */ (0, p.jsx)("strong", { children: "Address:" }),
					/* @__PURE__ */ (0, p.jsx)("span", { children: g(t) }),
					/* @__PURE__ */ (0, p.jsx)("button", {
						type: "button",
						"aria-label": "Go",
						children: "▼"
			...
			/* @__PURE__ */ (0, p.jsxs)("div", {
				className: `explorer-workspace${s ? " has-folders" : ""}`,
				children: [/* @__PURE__ */ (0, p.jsxs)("nav", {
					className: "explorer-tree",
					"aria-label": "Benchmark folders",
					children: [/* @__PURE__ */ (0, p.jsxs)("button", {
						type: "button",
						"aria-label": "浏览 Benchmarks",
						className: t === "root" ? "is-current" : "",
						onClick: () => f("root"),
						children: [
							/* @__PURE__ */ (0, p.jsx)("span", {
								className: "tree-twist",
							...
							/* @__PURE__ */ (0, p.jsx)("span", {
								className: "tree-computer-icon",
								"aria-hidden": "true"
							}),
							/* @__PURE__ */ (0, p.jsx)("span", { children: "Benchmarks" })
						]
					}), /* @__PURE__ */ (0, p.jsx)(_, {
						parentId: "root",
						currentId: t,
					...
					children: [/* @__PURE__ */ (0, p.jsxs)("table", { children: [/* @__PURE__ */ (0, p.jsx)("thead", { children: /* @__PURE__ */ (0, p.jsxs)("tr", { children: [
						/* @__PURE__ */ (0, p.jsx)("th", { children: "Name" }),
						/* @__PURE__ */ (0, p.jsx)("th", { children: "Type" }),
						/* @__PURE__ */ (0, p.jsx)("th", { children: "Status" })
					] }) }), /* @__PURE__ */ (0, p.jsx)("tbody", { children: u.map((t) => /* @__PURE__ */ (0, p.jsxs)("tr", {
						className: a === t.id ? "is-selected" : "",
						children: [
							/* @__PURE__ */ (0, p.jsx)("td", { children: /* @__PURE__ */ (0, p.jsxs)("button", {
								type: "button",
								...
								children: [
									/* @__PURE__ */ (0, p.jsx)("span", {
										"aria-hidden": "true",
										children: t.action.type === "external" ? "▣" : "▤"
									}),
									" ",
									t.name
								]
							}) }),
							/* @__PURE__ */ (0, p.jsx)("td", { children: t.type }),
							/* @__PURE__ */ (0, p.jsx)("td", { children: t.status })
						]
					}, t.id)) })] }), u.length === 0 && /* @__PURE__ */ (0, p.jsx)("p", {
			...
			/* @__PURE__ */ (0, p.jsxs)("div", {
				className: "explorer-statusbar",
				children: [
					/* @__PURE__ */ (0, p.jsxs)("span", { children: [
						u.length,
						" ",
						u.length === 1 ? "object" : "objects"
					] }),
					/* @__PURE__ */ (0, p.jsx)("span", { children: a ? d.items.find(({ id: e }) => e === a)?.type : "Select an item" }),
					a && /* @__PURE__ */ (0, p.jsx)("button", {
						type: "button",
						onClick: () => e(d.items.find(({ id: e }) => e === a)),
						children: "Open"
					})
				]
			})
...
//#endregion
//#region src/BootScreen.jsx
function y({ className: e, children: t, onSkip: n, ...r }) {
	return /* @__PURE__ */ (0, p.jsx)("section", {
		className: `boot-screen ${e}`,
		onPointerDown: n,
		...r,
		children: t
	});
}
function b({ variant: e, onSkip: t }) {
	return /* @__PURE__ */ (0, p.jsx)(y, {
		className: `boot-screen--black boot-screen--${e}`,
		onSkip: t,
		"aria-hidden": "true"
	});
}
function x({ onSkip: e }) {
	return /* @__PURE__ */ (0, p.jsx)(y, {
		...
		children: /* @__PURE__ */ (0, p.jsxs)("div", {
			className: "boot-post",
			children: [
				/* @__PURE__ */ (0, p.jsx)("strong", { children: "Shinonome Personal Computer" }),
				/* @__PURE__ */ (0, p.jsx)("span", { children: "CPU .............. OK" }),
				/* @__PURE__ */ (0, p.jsx)("span", { children: "Memory ........... OK" }),
				/* @__PURE__ */ (0, p.jsx)("span", { children: "Display .......... OK" }),
				/* @__PURE__ */ (0, p.jsx)("span", { children: "System Disk ...... OK" }),
				/* @__PURE__ */ (0, p.jsx)("span", {
					className: "boot-post-starting",
					children: "Starting Shinonome 95..."
				})
			]
		})
	});
}
function ee({ onSkip: e, reducedMotion: t = !1 }) {
	return /* @__PURE__ */ (0, p.jsx)(y, {
		className: `boot-screen--system${t ? " is-reduced" : ""}`,
		onSkip: e,
		role: "status",
		"aria-label": "Shinonome 95 startup",
		"aria-live": "polite",
		children: /* @__PURE__ */ (0, p.jsxs)("div", {
			className: "boot-system",
			children: [
				/* @__PURE__ */ (0, p.jsx)("strong", {
					lang: "ja",
					children: "東雲"
				}),
				/* @__PURE__ */ (0, p.jsx)("h1", { children: "Shinonome 95" }),
				/* @__PURE__ */ (0, p.jsx)("p", { children: t ? "Starting..." : "Starting Shinonome..." }),
...
//#endregion
//#region src/BootGate.jsx
var S = "shinonome95.boot.seen";
function C() {
	try {
		return window.localStorage.getItem(S) === "1";
	} catch {
		return !1;
	}
}
function te() {
	try {
		window.localStorage.setItem(S, "1");
	} catch {}
}
function ne({ children: e }) {
	let t = (0, l.useRef)(!C()).current, n = t ? "idle" : "desktop", [r, i] = (0, l.useState)(n), a = (0, l.useRef)(n), [o, s] = (0, l.useState)(!t), [c, u] = (0, l.useState)(!1), [d, f] = (0, l.useState)(+!!t), m = (0, l.useRef)(null), h = (0, l.useCallback)((e) => {
		a.current = e, i(e);
	}, []), g = (0, l.useCallback)(() => {
		a.current !== "desktop" && (m.current?.(), m.current = null, te(), h("desktop"), s(!0));
	}, [h]), _ = (0, l.useCallback)(() => {
		m.current?.(), m.current = null, s(!1), h("idle"), f((e) => e + 1);
	}, [h]);
	return (0, l.useEffect)(() => {
		if (d === 0) return;
		let e = window.matchMedia?.("(prefers-reduced-motion: reduce)").matches ?? !1;
		u(e);
		let t = [], n = !1, r = () => window.removeEventListener("keydown", o), i = () => {
			n || (n = !0, t.forEach((e) => window.clearTimeout(e)), r());
		}, a = (e, r) => {
		...
		function o(e) {
			[
				...
				"Enter",
				" "
			].includes(e.key) && (e.key === " " && e.preventDefault(), g());
		}
		return m.current = i, window.addEventListener("keydown", o), e ? (h("boot"), a(280, () => h("blackout")), a(380, () => {
			te(), r(), h("desktop");
		}), a(500, () => {
			s(!0), i();
		})) : (h("idle"), a(100, () => h("post")), a(700, () => h("boot")), a(2400, () => h("blackout")), a(2520, () => {
			te(), r(), h("desktop");
		}), a(2700, () => {
			s(!0), i();
		})), i;
		...
		e({
			desktopReady: r === "desktop",
			welcomeReady: o,
			restartSystem: _
		}),
		r === "idle" && /* @__PURE__ */ (0, p.jsx)(b, {
			variant: "idle",
			onSkip: g
		}),
		r === "post" && /* @__PURE__ */ (0, p.jsx)(x, { onSkip: g }),
		r === "boot" && /* @__PURE__ */ (0, p.jsx)(ee, {
			reducedMotion: c,
			onSkip: g
		}),
		r === "blackout" && /* @__PURE__ */ (0, p.jsx)(b, {
			variant: "blackout",
			onSkip: g
		})
	] });
...
//#endregion
//#region src/EvidenceNotepad.jsx
function re({ item: e }) {
	return /* @__PURE__ */ (0, p.jsxs)("article", {
		className: "evidence-note",
		children: [/* @__PURE__ */ (0, p.jsx)("pre", { children: e.summary.join("\n") }), /* @__PURE__ */ (0, p.jsxs)("div", {
			className: "evidence-note-source",
			children: [/* @__PURE__ */ (0, p.jsx)("a", {
				href: e.sourceUrl,
				target: "_blank",
				rel: "noreferrer",
				children: "Source"
			}), /* @__PURE__ */ (0, p.jsx)("span", { children: "Read-only evidence file" })]
		})]
	});
}
//#endregion
//#region src/desktopState.js
var w = {
...
function ae(e, t) {
	switch (t.type) {
		case "select-shortcut": return {
			...e,
			selectedShortcut: t.id,
			startOpen: !1
		};
		case "open-window": return ie(e, t.id);
		case "open-document": return ie(e, "evidence", { documentId: t.documentId });
		case "focus-window": return ie(e, t.id);
		case "toggle-taskbar": {
			let n = e.windows[t.id];
			return !n.open || n.minimized ? ie(e, t.id) : e.activeWindow === t.id ? {
				...e,
				activeWindow: null,
				windows: {
					...e.windows,
		...
		case "minimize-window": return {
			...e,
			activeWindow: e.activeWindow === t.id ? null : e.activeWindow,
			windows: {
				...e.windows,
				[t.id]: {
					...e.windows[t.id],
		...
		case "toggle-maximize": return ie(e, t.id, { maximized: !e.windows[t.id].maximized });
		case "close-window": return {
			...e,
			activeWindow: e.activeWindow === t.id ? null : e.activeWindow,
			windows: {
				...e.windows,
		...
		case "toggle-start": return {
			...e,
			startOpen: !e.startOpen,
			selectedShortcut: null
		};
		case "close-start": return {
			...e,
			startOpen: !1
		};
		default: return e;
...
function E() {
	return /* @__PURE__ */ (0, p.jsxs)(p.Fragment, { children: [
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M8 4H20V6H24V9H27V18H24V21H20V29H10V21H7V18H5V9H8Z",
			fill: T.black
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M9 5H19V7H23V10H25V17H22V20H18V27H11V20H8V17H6V10H9Z",
			fill: T.white
		}),
		/* @__PURE__ */ (0, p.jsx)("rect", {
			x: "10",
...
function D() {
	return /* @__PURE__ */ (0, p.jsxs)(p.Fragment, { children: [
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M6 8H19V4L27 11L19 18V14H10V19H5V11Z",
			fill: T.black
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M7 7H18V3L25 10L18 16V12H9V18H4V10Z",
			fill: T.cyan
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M26 23H13V28L5 21L13 14V18H22V13H27V21Z",
			fill: T.black
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M25 22H14V27L7 21L14 15V19H23V14H28V22Z",
			fill: "#b8f1f1"
		}),
		/* @__PURE__ */ (0, p.jsx)("rect", {
			x: "7",
...
function ue() {
	return /* @__PURE__ */ (0, p.jsxs)(p.Fragment, { children: [
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M8 7L11 9H21L24 7L25 12C28 14 29 18 27 22C25 25 22 27 18 27H14C10 27 7 25 5 22C3 18 4 14 7 12Z",
			fill: T.black
		}),
		/* @__PURE__ */ (0, p.jsx)("rect", {
			x: "8",
...
function fe() {
	return /* @__PURE__ */ (0, p.jsxs)(p.Fragment, { children: [
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M7 2H22L27 7V30H7Z",
			fill: T.black
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M6 1H21L26 6V29H6Z",
			fill: T.white
		}),
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M21 1V7H26",
		...
		/* @__PURE__ */ (0, p.jsx)("path", {
			d: "M10 8H20L15 15L21 22H9V19H16L11 14L16 10H10Z",
			fill: T.blue
		}),
		/* @__PURE__ */ (0, p.jsx)("text", {
			x: "16",
...
function he({ onCancel: e, onConfirm: t }) {
	return /* @__PURE__ */ (0, p.jsx)("div", {
		...
		children: /* @__PURE__ */ (0, p.jsxs)("section", {
			...
			role: "dialog",
			"aria-label": "Shut Down Shinonome 95",
			children: [
				/* @__PURE__ */ (0, p.jsx)("div", {
					className: "shutdown-titlebar",
					children: "Shut Down Shinonome 95"
				}),
				/* @__PURE__ */ (0, p.jsxs)("div", {
					className: "shutdown-body",
					children: [/* @__PURE__ */ (0, p.jsx)("span", {
						className: "shutdown-computer",
						"aria-hidden": "true",
						children: "▣"
					}), /* @__PURE__ */ (0, p.jsx)("p", { children: "Are you sure you want to shut down your computer?" })]
				}),
				/* @__PURE__ */ (0, p.jsxs)("div", {
...
function ge({ onPowerOn: e }) {
	return /* @__PURE__ */ (0, p.jsxs)("section", {
		className: "power-off",
		role: "status",
		"aria-label": "Computer is off",
		children: [/* @__PURE__ */ (0, p.jsx)("p", { children: "It is now safe to turn off your computer." }), /* @__PURE__ */ (0, p.jsx)("button", {
			type: "button",
			onClick: e,
			children: "Power On"
		})]
...
function ye() {
	return /* @__PURE__ */ (0, p.jsx)("div", {
		...
		role: "img",
		"aria-label": "Simplified CPU package preview",
		children: /* @__PURE__ */ (0, p.jsxs)("div", {
			className: "cpu-preview-simple-plate",
			children: [
				/* @__PURE__ */ (0, p.jsx)("strong", { children: "XEON" }),
				/* @__PURE__ */ (0, p.jsx)("span", { children: "MAX" }),
				/* @__PURE__ */ (0, p.jsx)("small", { children: "9470C" })
			]
		})
	});
}
...
function xe({ rows: e }) {
	return /* @__PURE__ */ (0, p.jsx)("dl", {
		...
		children: e.map(([e, t, n = !1]) => /* @__PURE__ */ (0, p.jsxs)("div", {
			className: n ? "is-multiline" : "",
			children: [/* @__PURE__ */ (0, p.jsx)("dt", { children: e }), /* @__PURE__ */ (0, p.jsx)("dd", { children: t })]
		}, e))
	});
}
function Se({ rows: e }) {
		...
		children: [/* @__PURE__ */ (0, p.jsx)("legend", { children: "Processor" }), /* @__PURE__ */ (0, p.jsxs)("div", {
			...
			children: [/* @__PURE__ */ (0, p.jsx)(xe, { rows: [["Name", e.name], [
				...
				children: [/* @__PURE__ */ (0, p.jsx)(Se, { rows: [
					...
					["NUMA Nodes", n.numaNodes],
					["Memory", `${t.capacity} ${t.type}`],
					["Memory Mode", t.configuration],
					[
						"OS",
						r.os,
						!0
...
function we() {
	...
	return /* @__PURE__ */ (0, p.jsxs)("fieldset", {
		...
		children: [/* @__PURE__ */ (0, p.jsx)("legend", { children: "Memory" }), /* @__PURE__ */ (0, p.jsx)(xe, { rows: [
			...
			["Related benchmark", e.relatedBenchmark]
		] })]
	});
}
function Te() {
...
function De({ onOpenBenchmarkExplorer: e, onOpenBenchmarkReport: t }) {
	return /* @__PURE__ */ (0, p.jsxs)("fieldset", {
		...
		children: [
			/* @__PURE__ */ (0, p.jsx)("legend", { children: "Links" }),
			/* @__PURE__ */ (0, p.jsxs)("div", { children: [
				/* @__PURE__ */ (0, p.jsx)("strong", { children: "Benchmark Explorer" }),
				/* @__PURE__ */ (0, p.jsx)("p", { children: "Browse published benchmark entries." }),
				/* @__PURE__ */ (0, p.jsx)("button", {
					type: "button",
			...
			/* @__PURE__ */ (0, p.jsxs)("div", { children: [
				/* @__PURE__ */ (0, p.jsx)("strong", { children: "Xeon Max 9470C Report" }),
				/* @__PURE__ */ (0, p.jsx)("p", { children: "Published benchmark report." }),
				/* @__PURE__ */ (0, p.jsx)("button", {
					type: "button",
					className: "profile-button",
...
function Ae({ id: e, title: t, windowState: n, dispatch: r, children: i, menu: a = !0, menuItems: o = [
	...
	let c = (0, l.useRef)(null), u = (0, l.useRef)(null);
	function d(t) {
		if (n.maximized || t.button !== 0) return;
		let i = c.current.getBoundingClientRect();
		u.current = {
			offsetX: t.clientX - i.left,
			offsetY: t.clientY - i.top
		}, t.currentTarget.setPointerCapture?.(t.pointerId), r({
			type: "focus-window",
			id: e
		});
	}
	function f(t) {
		...
		r({
			type: "move-window",
			id: e,
			x: Math.min(a, Math.max(4, t.clientX - u.current.offsetX)),
			y: Math.min(o, Math.max(4, t.clientY - u.current.offsetY))
		});
	}
	function m(e) {
		u.current && (u.current = null, e.currentTarget.hasPointerCapture?.(e.pointerId) && e.currentTarget.releasePointerCapture(e.pointerId));
	}
	let h = n.hasMoved ? {
		left: `${n.x}px`,
		top: `${n.y}px`
	...
	return /* @__PURE__ */ (0, p.jsxs)("section", {
		...
		role: "dialog",
		"aria-label": t,
		className: `win-window win-window--${e}${n.maximized ? " is-maximized" : ""}${s ? "" : " is-inactive"}`,
		style: {
			...h,
			zIndex: n.z
		},
		...
		children: [
			/* @__PURE__ */ (0, p.jsxs)("div", {
				...
				children: [
					...
					/* @__PURE__ */ (0, p.jsx)("strong", { children: t }),
					/* @__PURE__ */ (0, p.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, p.jsx)("button", {
								type: "button",
								"aria-label": `${n.maximized ? "还原" : "最大化"} ${t}`,
								onPointerDown: (e) => e.stopPropagation(),
								onClick: () => r({
									type: "toggle-maximize",
									id: e
			...
			a && /* @__PURE__ */ (0, p.jsx)("nav", {
				className: "win-menubar",
				"aria-label": `${t} 菜单`,
				children: o.map((e) => /* @__PURE__ */ (0, p.jsx)("button", {
					type: "button",
					children: e
				}, e))
			}),
...
var je = "https://bbs.shinonome.xyz/", Me = [
	...
	},
	{
		...
		label: "Portfolio",
		lines: ["Portfolio"],
		url: "https://portfolio.shinonome.xyz"
	},
	{
		id: "benchmark",
		label: "Benchmark",
	...
	{
		id: "xeon",
		label: "Xeon Max 9470C",
		lines: ["Xeon Max", "9470C"],
		windowId: "system-profiler"
	},
	{
		id: "cat",
		label: "CAT-Psych",
	...
	},
	{
		...
		label: "GitHub",
		lines: ["GitHub"],
		url: "https://github.com/2409324124"
	},
	{
		id: "visualization",
...
function Pe({ onOpenShortcut: e, onClose: t, onRestart: n, onShutdown: r }) {
	...
	return /* @__PURE__ */ (0, p.jsxs)("div", {
		...
		children: [/* @__PURE__ */ (0, p.jsxs)("div", {
			...
			"aria-hidden": "true",
			children: [/* @__PURE__ */ (0, p.jsx)("strong", { children: "Shinonome" }), /* @__PURE__ */ (0, p.jsx)("span", { children: "95" })]
		}), /* @__PURE__ */ (0, p.jsx)("div", {
			className: "start-menu-items",
			children: i.map((n, r) => n.separator ? /* @__PURE__ */ (0, p.jsx)("div", {
				className: "start-separator",
				role: "separator"
			}, `separator-${r}`) : /* @__PURE__ */ (0, p.jsxs)("button", {
				role: "menuitem",
				type: "button",
				onClick: () => {
					n.shortcut && e(n.shortcut), n.action && n.action(), t();
				},
				children: [
					/* @__PURE__ */ (0, p.jsx)("span", {
					...
					/* @__PURE__ */ (0, p.jsx)("span", { children: n.label }),
					/* @__PURE__ */ (0, p.jsx)("span", {
						"aria-hidden": "true",
						children: n.suffix
					})
...
function Fe() {
	...
	function s(e) {
		...
		window.open(e.url, e.url.startsWith("mailto:") ? "_self" : "_blank", "noopener,noreferrer");
	}
	function c(e) {
		t({
			type: "select-shortcut",
			id: e.id
		}), window.matchMedia?.("(pointer: coarse)").matches && s(e);
	}
	return /* @__PURE__ */ (0, p.jsx)(ne, { children: ({ desktopReady: r, welcomeReady: l, restartSystem: u }) => /* @__PURE__ */ (0, p.jsxs)(p.Fragment, { children: [
		i === "on" && r && /* @__PURE__ */ (0, p.jsxs)("main", {
			className: "desktop",
			children: [
				...
				l && e.windows.welcome.open && !e.windows.welcome.minimized && /* @__PURE__ */ (0, p.jsx)(Ae, {
					...
					dispatch: t,
					isActive: e.activeWindow === "welcome",
					children: /* @__PURE__ */ (0, p.jsxs)("div", {
						className: "welcome-copy",
						children: [
							/* @__PURE__ */ (0, p.jsx)("h1", { children: "东云 / Shinonome" }),
				...
				e.windows.benchmark.open && !e.windows.benchmark.minimized && /* @__PURE__ */ (0, p.jsx)(Ae, {
					...
					dispatch: t,
					isActive: e.activeWindow === "benchmark",
					menuItems: [
						"File",
						"Edit",
						"View",
					...
					children: /* @__PURE__ */ (0, p.jsx)(v, { onOpenItem: (e) => {
						e.action.type === "external" ? window.open(e.action.target, "_blank", "noopener,noreferrer") : e.action.type === "notepad" && t({
							type: "open-document",
							documentId: e.id
						});
					} })
				...
				e.windows["system-profiler"].open && !e.windows["system-profiler"].minimized && /* @__PURE__ */ (0, p.jsx)(Ae, {
					...
					dispatch: t,
					isActive: e.activeWindow === "system-profiler",
					menuItems: [
						"File",
						"Edit",
						"View",
				...
				/* @__PURE__ */ (0, p.jsxs)("footer", {
					...
					children: [
						/* @__PURE__ */ (0, p.jsxs)("button", {
							className: `start-button${e.startOpen ? " is-pressed" : ""}`,
							type: "button",
							"aria-label": "Start",
							"aria-expanded": e.startOpen,
							onClick: () => t({ type: "toggle-start" }),
							children: [/* @__PURE__ */ (0, p.jsx)("span", {
								className: "start-logo",
								"aria-hidden": "true",
								children: "▰"
							}), /* @__PURE__ */ (0, p.jsx)("strong", { children: "Start" })]
						}),
						/* @__PURE__ */ (0, p.jsx)("div", {
						...
						/* @__PURE__ */ (0, p.jsx)("div", {
							...
							children: Object.entries(e.windows).filter(([, e]) => e.open).map(([n, r]) => {
								let i = n === "welcome" ? "WELCOME.TXT" : n === "benchmark" ? "Benchmark Explorer" : n === "system-profiler" ? "System Profiler" : o?.fileName ?? "EVIDENCE.TXT";
								return /* @__PURE__ */ (0, p.jsxs)("button", {
									className: e.activeWindow === n && !r.minimized ? "is-active" : "",
									type: "button",
									"aria-label": `切换 ${i}`,
									onClick: () => t({
										type: "toggle-taskbar",
